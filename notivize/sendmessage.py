...
#         text = "hello there your OTP is " + otp     
        ...
        if request_json['token'] == "redacted":
            ...
            response = requests.post('https://events-api.notivize.com/applications/ffeefaec-bbf7-446c-8259-f422e893e9c4/event_flows/09451750-1987-4411-abe1-ca4a4eac5b36/events', json = { 'message': message, 'phone': receiver})
