        ...
        <div className="flex flex-row items-center justify-center">
          <div className="w-full text-center">
            <h1 className="text-white text-5xl font-semibold">
              Level-up your virtual
              <span className="text-pri-orange"> Work</span>
              <span className="text-pri-blue">.</span>
              <span className="text-pri-yellow">Space</span>
            </h1>
            <h2 className="text-white text-4xl font-semibold py-4">
              <span className="text-pri-orange">Get your work done, </span>
              <span className="text-pri-yellow bg-pri-blue rounded px-1">
                now.
              </span>
            </h2>
          </div>
          ...
          <div className="w-full flex flex-col sm:flex-row justify-between">
            <div className="flex flex-col justify-start">
              ...
              <div className="flex flex-row space-x-4 mt-4">
                <div className="w-12 h-12 bg-pri-yellow rounded-full flex flex-row justify-center items-center cursor-pointer">
                  <a
        ...
        <div className="max-w-screen-xl mx-auto sm:px-8 pt-8 pb-16 xl:px-0">
          <div className="flex flex-col sm:flex-row justify-between">
            ...
            <div className="flex flex-row space-x-8">
              ...
              <h5 className="text-xs text-gray-400">© 2021 Work.space</h5>
            </div>
          </div>
        </div>
      </div>
